        ...
        <div class="row justify-content-center flex-md-row">
          <div class="col-md-7">
            <div v-if="order.paid === false">
              <div class="d-flex">
                <h4 class="text-white mb-0 font-weight-bold">結帳</h4>
              </div>
            ...
            <div class="bg-dark" v-else>
              <div class="d-flex">
                <h4 class="text-white mb-0 font-weight-bold">訂單完成</h4>
              </div>
              <hr class="border-white hr-border-width">
              <p class="text-white">
          ...
          <div class="col-md-5 mt-3">
            <div class="border p-4">
              <h4 class="text-white font-weight-bold mb-3 d-flex justify-content-center
            justify-content-md-start">訂單明細</h4>
              ...
              <table class="table mt-4 border-top border-bottom text-secondary">
                <tbody>
                  <tr>
            ...
            <div class="row justify-content-end">
              <div class="col-md-6">
                <div v-if="order.paid === false">
                  <a @click.prevent="backHome" class="btn btn-outline-light d-none d-md-block" >
                  回到首頁
                  </a>
                </div>
                <div v-if="order.paid === false">
                  <a @click.prevent="backHome" class="mb-3 btn btn-outline-light btn-block
                  d-md-none">
                  回到首頁
                  </a>
                </div>
            ...
            <router-link to="/products" class="btn btn-outline-light mt-3 d-none d-md-block w-50"
            v-if="order.paid === true">
            繼續選購
            </router-link>
            <router-link to="/products" class="btn btn-outline-light mt-3 btn-block d-md-none"
            v-if="order.paid === true">
            繼續選購
            </router-link>
          </div>
